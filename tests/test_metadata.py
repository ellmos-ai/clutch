...
def test_llms_txt_structure_and_timestamp():
    ...
    assert "Last-checked: 2026-08-22" in llms_text, "llms.txt Last-checked timestamp should be 2026-08-22"
    assert "359" in llms_text, "llms.txt should report 359 passing unit tests"
